...
def GetMyTransaction(sended=None, validated=None, turn_json=False) -> list:
    ...
    if (len(naruno.transactions.my_transactions.get_my_transaction.
            mytransactions_db_ram) != mytransactions_db.get_count()):
        naruno.transactions.my_transactions.get_my_transaction.mytransactions_db_ram = (
            {})

    all_records = (mytransactions_db.get_all()
                   if naruno.transactions.my_transactions.get_my_transaction.
                   mytransactions_db_ram == {} else naruno.transactions.
                   my_transactions.get_my_transaction.mytransactions_db_ram)
