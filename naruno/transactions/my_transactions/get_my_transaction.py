...
def GetMyTransaction(sended=None, validated=None, turn_json=False) -> list:
    ...
    all_records = (
        ...
        if naruno.transactions.my_transactions.get_my_transaction.mytransactions_db_ram
        == {}
        else naruno.transactions.my_transactions.get_my_transaction.mytransactions_db_ram
    )
