...
def self_candidates(block: Block):
        ...
        if len(our_candidates) == 0 or (not the_block.sequence_number+the_block.empty_block_number == block.sequence_number+block.empty_block_number) or (the_block.sequence_number+the_block.empty_block_number == block.sequence_number+block.empty_block_number and the_block.round_1 != block.round_1):
            new_list = []
            signature_list = []
            a_time = "self"
