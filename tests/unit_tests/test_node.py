...
class Test_Node(unittest.TestCase):
    ...
    def test_GetCandidateBlocks(self):
        ...
        result.candidate_blocks[1]["transaction"][0] = result.candidate_blocks[1][
            "transaction"
        ][0].dump_json()
        self.assertEqual(
    ...
    def test_connection_timeout_client_side(self):
        ...
        temp_server = server("127.0.0.1", 10059, test=True)
        self.node_0.connect("127.0.0.1", 10059)
        time.sleep(10)
    ...
    def test_send_get_transaction(self):
        ...
        SaveBlock(
            ...
            custom_TEMP_BLOCKSHASH_PART_PATH=self.custom_TEMP_BLOCKSHASH_PART_PATH2,
        )
    ...
    def test_send_my_block_hash_get_candidate_block_hash(self):
        ...
        self.assertEqual(node_1_c_client.candidate_block_hash["action"], "myblockhash")
        self.assertEqual(node_1_c_client.candidate_block_hash["hash"], 58585858)

        self.assertEqual(node_2_c_client.candidate_block_hash["action"], "myblockhash")
        self.assertEqual(node_2_c_client.candidate_block_hash["hash"], 58585858)
    ...
    def test_send_my_block_get_candidate_block_multiple(self):
        ...
        self.assertEqual(self.node_1.clients[0].candidate_block["sequence_number"], 0)
        self.assertEqual(self.node_2.clients[0].candidate_block["sequence_number"], 0)
        ...
        self.assertEqual(self.node_1.clients[0].candidate_block["sequence_number"], 1)
        self.assertEqual(self.node_2.clients[0].candidate_block["sequence_number"], 1)
        self.assertNotEqual(self.node_1.clients[0].candidate_block_history, [])
        self.assertEqual(len(self.node_1.clients[0].candidate_block_history), 1)
        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[0]["sequence_number"], 0
        )
        self.assertNotEqual(self.node_2.clients[0].candidate_block_history, [])
        self.assertEqual(len(self.node_2.clients[0].candidate_block_history), 1)
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[0]["sequence_number"], 0
        )
        ...
        self.assertEqual(self.node_1.clients[0].candidate_block["sequence_number"], 2)
        self.assertEqual(self.node_2.clients[0].candidate_block["sequence_number"], 2)
        self.assertNotEqual(self.node_1.clients[0].candidate_block_history, [])
        self.assertEqual(len(self.node_1.clients[0].candidate_block_history), 2)
        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[1]["sequence_number"], 1
        )
        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[0]["sequence_number"], 0
        )
        self.assertNotEqual(self.node_2.clients[0].candidate_block_history, [])
        self.assertEqual(len(self.node_2.clients[0].candidate_block_history), 2)
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[1]["sequence_number"], 1
        )
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[0]["sequence_number"], 0
        )
        ...
        self.node_0.send_my_block(the_block)
        time.sleep(2)
        self.assertEqual(len(self.node_1.clients[0].candidate_block_history), 4)
        self.assertEqual(len(self.node_2.clients[0].candidate_block_history), 4)
        the_block.sequence_number = 5
        self.node_0.send_my_block(the_block)
        time.sleep(2)

        self.assertEqual(len(self.node_1.clients[0].candidate_block_history), 5)
        self.assertEqual(len(self.node_2.clients[0].candidate_block_history), 5)
        ...
        self.node_0.send_my_block(the_block)
        time.sleep(2)
        self.assertEqual(self.node_1.clients[0].candidate_block["sequence_number"], 6)
        self.assertEqual(self.node_2.clients[0].candidate_block["sequence_number"], 6)
        self.assertEqual(len(self.node_1.clients[0].candidate_block_history), 5)
        self.assertEqual(len(self.node_2.clients[0].candidate_block_history), 5)

        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[0]["sequence_number"], 1
        )
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[0]["sequence_number"], 1
        )

        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[4]["sequence_number"], 5
        )
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[4]["sequence_number"], 5
        )

        the_block.sequence_number = 7
        self.node_0.send_my_block(the_block)
        time.sleep(2)
        self.assertEqual(self.node_1.clients[0].candidate_block["sequence_number"], 7)
        self.assertEqual(self.node_2.clients[0].candidate_block["sequence_number"], 7)
        self.assertEqual(len(self.node_1.clients[0].candidate_block_history), 5)
        self.assertEqual(len(self.node_2.clients[0].candidate_block_history), 5)

        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[0]["sequence_number"], 2
        )
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[0]["sequence_number"], 2
        )

        self.assertEqual(
            self.node_1.clients[0].candidate_block_history[4]["sequence_number"], 6
        )
        self.assertEqual(
            self.node_2.clients[0].candidate_block_history[4]["sequence_number"], 6
        )
    ...
    def test_send_my_block_get_candidate_block_hash_multiple(self):
        ...
        self.assertEqual(node_1_c_client.candidate_block_hash["sequence_number"], 0)
        self.assertEqual(node_2_c_client.candidate_block_hash["sequence_number"], 0)
        ...
        self.assertEqual(node_1_c_client.candidate_block_hash["sequence_number"], 1)
        self.assertEqual(node_2_c_client.candidate_block_hash["sequence_number"], 1)
        self.assertNotEqual(node_1_c_client.candidate_block_hash_history, [])
        self.assertEqual(len(node_1_c_client.candidate_block_hash_history), 1)
        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[0]["sequence_number"], 0
        )
        self.assertNotEqual(node_2_c_client.candidate_block_hash_history, [])
        self.assertEqual(len(node_2_c_client.candidate_block_hash_history), 1)
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[0]["sequence_number"], 0
        )
        ...
        self.assertEqual(node_1_c_client.candidate_block_hash["sequence_number"], 2)
        self.assertEqual(node_2_c_client.candidate_block_hash["sequence_number"], 2)
        self.assertNotEqual(node_1_c_client.candidate_block_hash_history, [])
        self.assertEqual(len(node_1_c_client.candidate_block_hash_history), 2)
        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[1]["sequence_number"], 1
        )
        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[0]["sequence_number"], 0
        )
        self.assertNotEqual(node_2_c_client.candidate_block_hash_history, [])
        self.assertEqual(len(node_2_c_client.candidate_block_hash_history), 2)
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[1]["sequence_number"], 1
        )
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[0]["sequence_number"], 0
        )
        ...
        self.node_0.send_my_block_hash(the_block)
        time.sleep(2)
        self.assertEqual(len(node_1_c_client.candidate_block_hash_history), 4)
        self.assertEqual(len(node_2_c_client.candidate_block_hash_history), 4)
        the_block.sequence_number = 5
        self.node_0.send_my_block_hash(the_block)
        time.sleep(2)

        self.assertEqual(len(node_1_c_client.candidate_block_hash_history), 5)
        self.assertEqual(len(node_2_c_client.candidate_block_hash_history), 5)
        ...
        self.node_0.send_my_block_hash(the_block)
        time.sleep(2)
        self.assertEqual(node_1_c_client.candidate_block_hash["sequence_number"], 6)
        self.assertEqual(node_2_c_client.candidate_block_hash["sequence_number"], 6)
        self.assertEqual(len(node_1_c_client.candidate_block_hash_history), 5)
        self.assertEqual(len(node_2_c_client.candidate_block_hash_history), 5)

        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[0]["sequence_number"], 1
        )
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[0]["sequence_number"], 1
        )

        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[4]["sequence_number"], 5
        )
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[4]["sequence_number"], 5
        )

        the_block.sequence_number = 7
        self.node_0.send_my_block_hash(the_block)
        time.sleep(2)
        self.assertEqual(node_1_c_client.candidate_block_hash["sequence_number"], 7)
        self.assertEqual(node_2_c_client.candidate_block_hash["sequence_number"], 7)
        self.assertEqual(len(node_1_c_client.candidate_block_hash_history), 5)
        self.assertEqual(len(node_2_c_client.candidate_block_hash_history), 5)

        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[0]["sequence_number"], 2
        )
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[0]["sequence_number"], 2
        )

        self.assertEqual(
            node_1_c_client.candidate_block_hash_history[4]["sequence_number"], 6
        )
        self.assertEqual(
            node_2_c_client.candidate_block_hash_history[4]["sequence_number"], 6
        )
    ...
    def test_send_my_block_get_candidate_block_multiple_with_function_try(self):
        ...
        candidate_blocks = GetCandidateBlocks(
            custom_nodes_list=nodes, block=the_block, reset=True
        )
