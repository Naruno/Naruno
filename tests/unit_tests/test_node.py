...
class Test_Node(unittest.TestCase):
    ...
    def test_GetCandidateBlocks(self):
        ...
        self.assertEqual(result.candidate_blocks, [value_1, {'action': 'myblock', 'transaction': [
                         the_transaction.dump_json()], 'signature': 'self', 'sequence_number': 0}])
    ...
    def test_GetCandidateBlocks_different_squance_number(self):
        ...
        self.assertEqual(result.candidate_blocks, [value_1_old, {
                         'action': 'myblock', 'transaction': [], 'signature': 'self', 'sequence_number': 0}])
        self.assertEqual(result.candidate_block_hashes, [value_3_old])

        the_block.sequence_number = 1
        result = GetCandidateBlocks(block=the_block)
        self.assertEqual(result.candidate_blocks, [value_1_old_1, {
                         'action': 'myblock', 'transaction': [], 'signature': 'self', 'sequence_number': 1}])
    ...
    def test_send_my_block_get_candidate_block_multiple_with_function_try(self):
        ...
        candidate_blocks = GetCandidateBlocks(
            custom_nodes_list=nodes, block=the_block)
    ...
    def test_send_my_block_get_candidate_block_hash_multiple_with_function_try_non(self):
