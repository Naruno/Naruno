...
from decentra_network.blockchain.block.blocks_hash import GetBlockshash, GetBlockshash_part, SaveBlockshash_part
...
class Test_Transactions(unittest.TestCase):
    ...
    def test_GetProof_no_transaction(self):
        ...
        custom_TEMP_ACCOUNTS_PATH = "db/test_GetProof_no_transaction_TEMP_ACCOUNTS_PATH.json"
        custom_TEMP_BLOCKSHASH_PATH = "db/test_GetProof_no_transaction_TEMP_BLOCKSHASH_PATH.json"
        custom_TEMP_BLOCKSHASH_PART_PATH = "db/test_GetProof_no_transaction_TEMP_BLOCKSHASH_PART_PATH.json"
    ...
    def test_GetProof_CheckProof_false(self):
        ...
        custom_BLOCKS_PATH = "db/test_finished_main/"
        custom_TEMP_ACCOUNTS_PATH = "db/test_finished_main_TEMP_ACCOUNTS_PATH.json"
        custom_TEMP_BLOCKSHASH_PATH = "db/test_GetProof_CheckProof_false_TEMP_BLOCKSHASH_PATH.json"
        custom_TEMP_BLOCKSHASH_PART_PATH = "db/test_GetProof_CheckProof_false_TEMP_BLOCKSHASH_PART_PATH.json"
