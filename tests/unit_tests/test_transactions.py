...
class Test_Transactions(unittest.TestCase):
    ...
    def test_ProccesstheTransaction_account_list(self):
        ...
        self.assertEqual(
            account_list["73cd109827c0de9fa211c0d062eab13584ea6bb8"][1],
            94999.98)
        self.assertEqual(
            account_list["73cd109827c0de9fa211c0d062eab13584ea6bb8"][0], 1)

        self.assertEqual(
            account_list["08fe9bfc6521565c601a3785c5f5fb0a406279e6"][1],
            94999.98)
        ...
        self.assertEqual(
            account_list["6a4236cba1002b2919651677c7c520b67627aa2a"][1],
            94999.98)
        self.assertEqual(
            account_list["6a4236cba1002b2919651677c7c520b67627aa2a"][0], 1)

        self.assertEqual(
            account_list["d10d419bae75549222c5ffead625a9e0246ad3e6"][1],
            104999.98)
        self.assertEqual(
