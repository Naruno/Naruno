...
class Test_Accounts(unittest.TestCase):
    ...
    def test_GetBalance_not_list_account(self):
        ...
        the_account = Account(
            "dbd811a12104827240153c8fd2f25a294a851ec8", 10, 1)
        the_account_2 = Account(
            "15562b06dc6b1acd6e8c86031e564e0c451c7a73", 15, 1)
        the_account_3 = Account(
            "7340ac0cdf3f7b59cba4ec6348ee8e41d0c24ef1", 20, 1)
    ...
    def test_GetBalance(self):
        ...
        self.assertEqual(result, 5)
        result_2 = GetBalance(block, "test_account_2",
                              account_list=account_list)
        self.assertEqual(result_2, 10)
        result_3 = GetBalance(block, "test_account_3",
                              account_list=account_list)
    ...
    def test_GetSequanceNumber_not_list_account(self):
        ...
        the_account = Account(
            "dbd811a12104827240153c8fd2f25a294a851ec8", 10, 1)
        the_account_2 = Account(
            "15562b06dc6b1acd6e8c86031e564e0c451c7a73", 15, 2)
        the_account_3 = Account(
            "7340ac0cdf3f7b59cba4ec6348ee8e41d0c24ef1", 20, 3)
    ...
    def test_GetSequanceNumber(self):
        ...
        result_2 = GetSequanceNumber(
            "test_account_2", account_list=account_list)
        self.assertEqual(result_2, 2)
        result_3 = GetSequanceNumber(
            "test_account_3", account_list=account_list)
