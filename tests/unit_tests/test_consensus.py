...
class Test_Consensus(unittest.TestCase):
    ...
    def test_rescue_main(self):
        ...
        self.node_0 = server(
            ...
            custom_LOADING_BLOCKSHASH_PART_PATH=self.custom_LOADING_BLOCKSHASH_PART_PATH0,
            custom_CONNECTED_NODES_PATH=self.custom_CONNECTED_NODES_PATH0,
            custom_PENDING_TRANSACTIONS_PATH=self.custom_PENDING_TRANSACTIONS_PATH0,
        ...
        self.node_1 = server(
            ...
            custom_LOADING_BLOCKSHASH_PART_PATH=self.custom_LOADING_BLOCKSHASH_PART_PATH1,
            custom_CONNECTED_NODES_PATH=self.custom_CONNECTED_NODES_PATH1,
            custom_PENDING_TRANSACTIONS_PATH=self.custom_PENDING_TRANSACTIONS_PATH1,
            custom_variables=True,
        )
        self.node_2 = server(
            "127.0.0.1",
            ...
            custom_LOADING_BLOCKSHASH_PART_PATH=self.custom_LOADING_BLOCKSHASH_PART_PATH2,
            custom_CONNECTED_NODES_PATH=self.custom_CONNECTED_NODES_PATH2,
            custom_PENDING_TRANSACTIONS_PATH=self.custom_PENDING_TRANSACTIONS_PATH2,
            custom_variables=True,
        )
