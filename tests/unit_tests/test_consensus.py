...
class Test_Consensus(unittest.TestCase):
    ...
    def test_finished_main_no_save(self):
        ...
        custom_TEMP_ACCOUNTS_PATH = "db/test_finished_main_no_save_TEMP_ACCOUNTS_PATH.json"
        custom_TEMP_BLOCKSHASH_PATH = "db/test_finished_main_no_save_TEMP_BLOCKSHASH_PATH.json"
        custom_TEMP_BLOCKSHASH_PART_PATH = (
    ...
    def test_finished_main_no_save_0(self):
        ...
        custom_BLOCKS_PATH = "db/test_finished_main/"
        custom_TEMP_ACCOUNTS_PATH = "db/test_finished_main_no_save_0_TEMP_ACCOUNTS_PATH.json"
        custom_TEMP_BLOCKSHASH_PATH = "db/test_finished_main_no_save_0_TEMP_BLOCKSHASH_PATH.json"
        custom_TEMP_BLOCKSHASH_PART_PATH = (
