...
class Test_Settings(unittest.TestCase):
    ...
    def test_creating_settings(self):
        ...
        self.assertIsNotNone(
            temp_settings["test_mode"], "A problem on the test_mode.")
        self.assertIsNotNone(
    ...
    def test_saving_settings(self):
        ...
        self.assertEqual(
            temp_test_settings["test_mode"], True, "A problem on the saving the settings.")
        self.assertEqual(
            temp_test_settings["debug_mode"], True, "A problem on the saving the settings.")
        ...
        self.assertEqual(
            temp_test_settings2["test_mode"], False, "A problem on the saving the settings.")
        self.assertEqual(
            temp_test_settings2["debug_mode"], False, "A problem on the saving the settings.")
