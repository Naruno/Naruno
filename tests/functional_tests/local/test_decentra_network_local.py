...
class Test_Decentra_Network_Local(unittest.TestCase):
    def test_1_different_network_one_transacton(self):
        ...
        for i in range(2):
            ...
            wallet_2_json = json.loads(
                urllib.request.urlopen("http://localhost:8100/wallet/create/123")
                .read()
                .decode()
            )
            wallet_2_address = (
            ...
            balance_wallet_1 = json.loads(
                urllib.request.urlopen("http://localhost:8100/wallet/balance")
                .read()
                .decode()
            )
    ...
    def test_2_different_network_multi_transacton(self):
        ...
        for i in range(2):
            ...
            temp_environment.start()
            wallet_2_json = json.loads(
                urllib.request.urlopen("http://localhost:8100/wallet/print")
                .read()
                .decode()
            )
            wallet_2_address = (
