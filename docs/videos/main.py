...
class Decentra_Network_Scene(Scene):
    ...
    def creating_nodes(self):
        ...
        self.node_1_text = Text("Node 1", font=self.font).next_to(self.node_1, UP)
        self.node_2_text = Text("Node 2", font=self.font).next_to(self.node_2, UP)
        self.node_3_text = Text("Node 3", font=self.font).next_to(self.node_3, UP)


        self.play(Create(self.node_1), Create(self.node_2), Create(self.node_3))
        self.play(Write(self.node_1_text), Write(self.node_2_text), Write(self.node_3_text))
        self.wait()        
    ...
    def create_node_connections(self):
        ...
        self.play(Create(self.connection_1), Create(self.connection_3), Create(self.connection_2)) 
    ...
    def create_security_circles(self):
        ...
        """
        self.play(FadeOut(self.node_1_text), FadeOut(self.node_2_text), FadeOut(self.node_3_text))
        ...
        self.secuirty_circle_1_text = Text("Security Circle 1", font=self.font).next_to(self.security_circle_1_components, UP)
        ...
        self.secuirty_circle_2_text = Text("Security Circle 2", font=self.font).next_to(self.security_circle_2_components, UP).set_color("#5EC295").scale(0.5)
        ...
        self.secuirty_circle_3_text = Text("Security Circle 3", font=self.font).next_to(self.security_circle_3_components, UP).set_color("#5EC295").scale(0.5)
        ...
        self.secuirty_circle_4_text = Text("Security Circle 4", font=self.font).next_to(self.security_circle_4_components, UP).set_color("#5EC295").scale(0.5)
        ...
        self.circle_2 = Circle(color="#5EC295").scale(1.5).shift(2*UP).shift(3*RIGHT)
        self.circle_3 = Circle(color="#5EC295").scale(1.5).shift(2*UP).shift(3*LEFT + 3.5*DOWN)
        self.circle_4 = Circle(color="#5EC295").scale(1.5).shift(2*UP).shift(3*RIGHT + 3.5*DOWN)
        self.play(
    ...
    def creates_network(self):
        ...
        self.i_all = Intersection(self.circle_1, self.circle_2, self.circle_3, self.circle_4)
    ...
    def data_running_through_the_intersections_and_circles(self):
        ...
        self.dot_circle_1 = Dot(color="#5EC295").move_to(self.circle_1.get_right()).scale(1.5)
        self.dot_circle_2 = Dot(color="#5EC295").move_to(self.circle_2.get_right()).scale(1.5)
        self.dot_circle_3 = Dot(color="#5EC295").move_to(self.circle_3.get_right()).scale(1.5)
        self.dot_circle_4 = Dot(color="#5EC295").move_to(self.circle_4.get_right()).scale(1.5)
