...
class Decentra_Network_Scene(Scene):
    ...
    def creating_nodes(self):
        ...
        self.node_1_text = Text(
            "Node 1", font=self.font).next_to(self.node_1, UP)
        self.node_2_text = Text(
            "Node 2", font=self.font).next_to(self.node_2, UP)
        self.node_3_text = Text(
            "Node 3", font=self.font).next_to(self.node_3, UP)

        self.play(Create(self.node_1), Create(
            self.node_2), Create(self.node_3))
        self.play(Write(self.node_1_text), Write(
            self.node_2_text), Write(self.node_3_text))
        self.wait()
    ...
    def create_node_connections(self):
        ...
        """
        self.connection_1 = Line(
            self.node_1.get_center(), self.node_2.get_center())
        self.connection_2 = Line(
            self.node_2.get_center(), self.node_3.get_center())
        self.connection_3 = Line(
            self.node_3.get_center(), self.node_1.get_center())

        self.play(Create(self.connection_1), Create(
            self.connection_3), Create(self.connection_2))

    def create_security_circles(self):
        """
        When a connections are have more than two node, we call security circle.
        """
        self.play(FadeOut(self.node_1_text), FadeOut(
            self.node_2_text), FadeOut(self.node_3_text))
        ...
        self.secuirty_circle_1_text = Text("Security Circle 1", font=self.font).next_to(
            self.security_circle_1_components, UP)
        self.security_circle_1 = VGroup(
            self.security_circle_1_components,
        ...
        self.play(
            self.security_circle_1.animate.shift(2 * UP)
        )

        self.security_circle_2_components = self.security_circle_1_components.copy()
        self.secuirty_circle_2_text = Text("Security Circle 2", font=self.font).next_to(
            self.security_circle_2_components, UP).set_color("#5EC295").scale(0.5)
        self.security_circle_2 = VGroup(
            self.security_circle_2_components,
            self.secuirty_circle_2_text
        )
        self.security_circle_3_components = self.security_circle_1_components.copy()
        self.secuirty_circle_3_text = Text("Security Circle 3", font=self.font).next_to(
            self.security_circle_3_components, UP).set_color("#5EC295").scale(0.5)
        self.security_circle_3 = VGroup(
            self.security_circle_3_components,
            self.secuirty_circle_3_text
        )
        self.security_circle_4_components = self.security_circle_1_components.copy()
        self.secuirty_circle_4_text = Text("Security Circle 4", font=self.font).next_to(
            self.security_circle_4_components, UP).set_color("#5EC295").scale(0.5)
        self.security_circle_4 = VGroup(
            self.security_circle_4_components,
        ...
        self.circle_1 = Circle(color="#5EC295").scale(
            1.5).shift(2 * UP).shift(3 * LEFT)
        self.circle_2 = Circle(color="#5EC295").scale(
            1.5).shift(2 * UP).shift(3 * RIGHT)
        self.circle_3 = Circle(color="#5EC295").scale(
            1.5).shift(2 * UP).shift(3 * LEFT + 3.5 * DOWN)
        self.circle_4 = Circle(color="#5EC295").scale(
            1.5).shift(2 * UP).shift(3 * RIGHT + 3.5 * DOWN)
        self.play(
    ...
    def creates_network(self):
        ...
        self.play(
            ...
            self.circle_3.animate.shift(
                1.8 * DOWN).shift(2 * RIGHT + 2.5 * UP),
    ...
    def data_running_through_the_intersections_and_circles(self):
        ...
        """
        self.dot_i_all = Dot(color="#5EC295").move_to(
            self.i_all.get_right()).scale(1.5)
        self.dot_i_12 = Dot(color="#5EC295").move_to(
            self.i_12.get_right()).scale(1.5)
        self.dot_i_13 = Dot(color="#5EC295").move_to(
            self.i_13.get_right()).scale(1.5)
        self.dot_i_14 = Dot(color="#5EC295").move_to(
            self.i_14.get_right()).scale(1.5)
        self.dot_i_23 = Dot(color="#5EC295").move_to(
            self.i_23.get_right()).scale(1.5)
        self.dot_i_24 = Dot(color="#5EC295").move_to(
            self.i_24.get_right()).scale(1.5)
        self.dot_i_34 = Dot(color="#5EC295").move_to(
            self.i_34.get_right()).scale(1.5)

        self.dot_circle_1 = Dot(color="#5EC295").move_to(
            self.circle_1.get_right()).scale(1.5)
        self.dot_circle_2 = Dot(color="#5EC295").move_to(
            self.circle_2.get_right()).scale(1.5)
        self.dot_circle_3 = Dot(color="#5EC295").move_to(
            self.circle_3.get_right()).scale(1.5)
        self.dot_circle_4 = Dot(color="#5EC295").move_to(
