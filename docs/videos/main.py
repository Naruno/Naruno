...
class Decentra_Network_Scene(Scene):
    ...
    def creating_nodes(self):
        ...
        self.play(Create(self.node_1), Create(self.node_2),
                  Create(self.node_3))
        self.play(Write(self.node_1_text), Write(self.node_2_text),
                  Write(self.node_3_text))
        self.wait()
    ...
    def create_node_connections(self):
        ...
        """
        self.connection_1 = Line(self.node_1.get_center(),
                                 self.node_2.get_center())
        self.connection_2 = Line(self.node_2.get_center(),
                                 self.node_3.get_center())
        self.connection_3 = Line(self.node_3.get_center(),
                                 self.node_1.get_center())
    ...
    def create_security_circles(self):
        ...
        self.circle_1 = Circle(color="#5EC295").scale(1.5).shift(2 * UP).shift(
            3 * LEFT)
        self.circle_2 = (Circle(color="#5EC295").scale(1.5).shift(
            2 * UP).shift(3 * RIGHT))
        self.circle_3 = (Circle(color="#5EC295").scale(1.5).shift(
            2 * UP).shift(3 * LEFT + 3.5 * DOWN))
        self.circle_4 = (Circle(color="#5EC295").scale(1.5).shift(
    ...
    def creates_network(self):
        ...
        self.play(
            ...
            self.circle_3.animate.shift(1.8 * DOWN).shift(2 * RIGHT +
                                                          2.5 * UP),
            self.circle_4.animate.shift(1.8 * DOWN).shift(2 * LEFT + 2.5 * UP),
        )

        # intersections of the circles
        self.i_all = Intersection(self.circle_1, self.circle_2, self.circle_3,
                                  self.circle_4)
