...
license='MPL-2.0',
packages=["", "accounts", "app", "blockchain", "blockchain/block", "blockchain/candidate_block", "consensus", "db", "db/blocks", "gui_lib", "gui_lib/fonts", "gui_lib/images", "gui_lib/libs", "gui_lib/libs/baseclass", "gui_lib/libs/kv", "lib", "node", "transactions", "wallet"],
package_data={
    "": ["*"],
