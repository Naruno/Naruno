...
setup(
    ...
    keywords=["python", "cryptography", "blockchain", "p2p", "python3", "cryptocurrency", "kivy", "coin", "copilot",
              "fba", "dapps", "p2p-network", "kivymd", "blokzinciri", "decentra-network", "githubcopilot", "blokzincir"],
    ...
    entry_points={
        ...
        ["dngui = decentra_network.gui:start",
            "dncli=decentra_network.cli:start", "dnapi=decentra_network.api:start"],
    },
    license="MPL-2.0",
    classifiers=[
