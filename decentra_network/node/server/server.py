...
class server(Thread):
    ...
    def __init__(
        ...
        self.LOADING_BLOCKSHASH_PART_PATH = LOADING_BLOCKSHASH_PART_PATH if custom_LOADING_BLOCKSHASH_PART_PATH is None else custom_LOADING_BLOCKSHASH_PART_PATH
