...
class GUI(MDApp):
    ...
    def build(self):
        ...
        self.theme_cls.font_styles.update({
            ...
            "H4":
            [os.path.join(self.FONT_PATH, "Poppins-Regular"), 34, False, 0.25],
            ...
            "Body1":
            [os.path.join(self.FONT_PATH, "Poppins-Regular"), 16, False, 0.5],
            "Body2":
            [os.path.join(self.FONT_PATH, "Poppins-Light"), 14, False, 0.25],
            "Button":
            [os.path.join(self.FONT_PATH, "Poppins-Bold"), 14, True, 1.25],
            "Caption":
            [os.path.join(self.FONT_PATH, "Poppins-Regular"), 12, False, 0.4],
            "Overline":
            [os.path.join(self.FONT_PATH, "Poppins-Regular"), 10, True, 1.5],
        })
