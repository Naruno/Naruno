...
def safety_check(
    ...
    try:
        ...
        pywall_class = exec(the_import_string) if custom_pywall is None else custom_pywall
        ...
        debug_mode = the_settings()["debug_mode"] if custom_debug_mode is None else custom_debug_mode
