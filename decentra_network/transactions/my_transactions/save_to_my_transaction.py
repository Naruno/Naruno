...
def SavetoMyTransaction(tx: Transaction, validated: bool=False, custom_currently_list: list=None) -> list:
    """
    ...
    currently_list = GetMyTransaction() if custom_currently_list is None else custom_currently_list
