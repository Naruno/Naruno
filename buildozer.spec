...
requirements =  naruno==0.46.4, Kivy==2.1.0, waitress==2.1.2, werkzeug==2.0.3, flask==2.0.0, flask_cors==3.0.10

[app@gui]
title = Naruno-GUI
package.name = naruno_gui
source.dir = naruno/gui/
requirements =  naruno==0.46.4, Kivy==2.1.0, kivymd==0.104.2, qrcode==7.3.1, kivymd_extensions.sweetalert==0.1.5, plyer==2.1.0, pillow==9.1.1
